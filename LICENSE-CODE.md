...
This applies to the **code** of this repository (scripts, GitHub Actions workflows). The **content** (lessons, text, materials) is licensed under CC BY 4.0 — see `LICENSE.md`.
